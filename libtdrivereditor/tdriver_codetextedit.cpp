...
{
    // example contents from tdriver_parameters.xml for reference
    /*
    <parameter name="localisation_server_ip" value="trmatti1.nmp.nokia.com" />
    <parameter name="localisation_server_username" value="locale" />
    <parameter name="localisation_server_password" value="password" />
    <parameter name="localisation_server_database_name" value="matti_locale" />

    <parameter name="language" value="English-GB" />
    <parameter name="localisation_server_database_tablename" value="example_loc_table" />
    */
